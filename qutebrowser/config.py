...
c.bindings.key_mappings['<Ctrl-6>'] = '<Ctrl-^>'
...
c.bindings.key_mappings[ '<Ctrl-Enter>'] = '<Return>'
...
## Type: Dict
c.content.headers.custom = {"accept": "text/html,application/xhtml+xml,application/xml,aplication/xml;q=0.9,*/*;q=0.8"}
...
## Type: ShellCommand
c.editor.command = ['vim', '{file}', 'normal {line}G{column0}l']
...
## Type: String
c.hints.border = '1px solid #F1FA8C'
...
## hints.
## Type: Dict
c.hints.selectors['all'] = ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'frame', 'iframe', 'img', 'link', 'summary', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]', '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]']
c.hints.selectors['links'] = ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]']
c.hints.selectors['images'] = ['img']
c.hints.selectors['media'] = ['audio', 'img', 'video']
c.hints.selectors['url'] = ['[src]', '[href]']
c.hints.selectors['inputs'] = ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]', 'input[type="email"]', 'input[type="month"]', 'input[type="number"]', 'input[type="password"]', 'input[type="search"]', 'input[type="tel"]', 'input[type="time"]', 'input[type="url"]', 'input[type="week"]', 'input:not([type])', 'textarea']
...
## Type: Bool
c.tabs.tabs_are_windows = False ## Alignment of the text inside of tabs.  ## Type: TextAlignment ## Valid values:
##   - left
##   - right
##   - center
...
c.url.searchengines['DEFAULT'] = 'https://duckduckgo.com/?q={}'
c.url.searchengines['wiki'] = 'https://wiki.archlinux.org/?search={}'
c.url.searchengines['aur'] = 'https://aur.archlinux.org/packages/?K={}'
c.url.searchengines['google'] = 'https://google.com/search?hl=en&q={}'
